...
export const CONTACT_US_SUBHEADING = "contactUsSubheading"
export const VALUE_PROP_MAIN_TEXT = "valuePropMainText"
export const VALUE_PROP_DESC = "valuePropDesc"
export const BENEFITS_FIRST = "benefitsFirst"
export const BENEFITS_FIRST_SUBTEXT = "benefitsFirstSubtext"
export const BENEFITS_SECOND = "benefitsSecond"
export const BENEFITS_SECOND_SUBTEXT = "benefitsSecondSubtext"
export const BENEFITS_THIRD = "benefitsThird"
export const BENEFITS_THIRD_SUBTEXT = "benefitsThirdSubtext"
export const PRODUCT_FEATURES_TITLE = "productFeaturesTitle"
export const PRODUCT_FEATURES_STATS_TITLE = "productFeaturesStatsTitle"
export const PRODUCT_FEATURES_STATS_TEXT = "productFeaturesStatsText"
export const PRODUCT_FEATURES_LANGUAGE_TITLE = "productFeaturesLanguageTitle"
export const PRODUCT_FEATURES_LANGUAGE_TEXT = "productFeaturesLanguageText"
export const PRODUCT_FEATURES_DEVS_TITLE = "productFeaturesDevsTitle"
export const PRODUCT_FEATURES_DEVS_TEXT = "productFeaturesDevsText"
export const CALL_TO_ACTION_TEXT = "callToActionText"
export const HEADER_HOME = "headerHome"
export const HEADER_BENEFITS = "headerBenefits"
export const HEADER_FEATURES = "headerFeatures"
export const ABOUT_HEADER = "aboutHeader"
export const BLOG_HEADER = "blogHeader"
export const FORM_NAME_LABEL = "formNameLabel"
export const FORM_EMAIL_LABEL = "formEmailLabel"
export const FORM_MSG_LABEL = "formMsgLabel"
